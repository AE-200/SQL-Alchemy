...
@app.route("/")
def home():
    return "Welcome to the climate API!<br/> Routes available are:<br/>/api/v1.0/precipitation<br/> /api/v1.0/stations<br/> /api/v1.0/tobs<br/> /api/v1.0/(start)<br/> /api/v1.0/(start)/(end)"
